...
const AddEpisode = () => {
    ...
    return (
            ...
            linkFilmId = `link-${index}`;
                ...
                <input type="text" placeholder="link filem"  style={styl1}
                name={linkFilmId}
                data-id={index}
                id={linkFilmId}
                />
                ...
                <Button variant="contained" color="secondary" style={{width:470,marginTop:7,marginRight:10}} className="" onClick={addRate}>
                            +
                </Button>
                </form>
            </div>
